...
iphone_mozilla_settings = TikTokScrapperConfig(
    ms_token=(
        "kWAM8FmtQBcUbCBd1Mu1JReYrNpKL1OWMkLuYCVSbv3rWDo-UhRD9ViOKKyJ9PntnrydvG2jFVvsukex6BYHOX-"
        "iFC0Fzg5CfcADftcBwAi9omXe1NtnhSQuP2S2J5zkBcdZfGGQPFvNsGH3"
    ),
    ...
    cookies={
        ...
        '__tea_cache_tokens_1988': (
            ...
            'user_unique_id%22:%227289951420127856161%22%2C%22timestamp%22:1697324095098}'
        ),
        ...
        'perf_feed_cache': (
            '{%22expireTimestamp%22:1697493600000%2C%22itemIds%22:'
            '[%227282547030654782752%22%2C%227276792487140805893%22]}'
        ),
        ...
        'ttwid': (
            '1%7CmOwlKOGX_hzGTArKlHzCj8_CD7iS4qDwcuLcR1xwWcU'
            '%7C1697636865%7Cc3403a248c3ad20b929a3fa43a5e36524fef1ae3e1470a08683046ed4d441501'
        ),
    },
    params={
        'aid': '1988',
        ...
        'browser_version': (
            '5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) '
...
ubuntu_edge_settings = TikTokScrapperConfig(
    ...
    cookies={
        ...
        "__tea_cache_tokens_1988": (
            "{%22_type_%22:%22default%22%2C%22"
            "user_unique_id%22:%227298674240000624133%22%2C%22timestamp%22:1699511857566}"
        ),
        'tiktok_webapp_theme': 'light',
        'odin_tt': (
        ...
        "perf_feed_cache": (
            '{%22expireTimestamp%22:1699959600000%2C%22itemIds%22:'
            '[%227268940080889220357%22%2C%227284544040828390662%22]}'
        ),
        ...
        "ttwid": (
            "1%7C3JbdrNra2QvlI3q2QIjNCv8GQuAunxZkYMO8uYQeRMk%7C1699789914%7C453dd2f6e"
            "8f1ebaf05e2f9a81d7e7fadd07460b1782266a700ad4cd6b4231a2d"
        ),
    },
    params={
        'aid': '1988',
...
windows_edge_settings = TikTokScrapperConfig(
    ms_token=(
        'DdssctqyIkoXmgE6tyy8mZXSk9FXMjpFrEqusx0Co_tYeGE2K3OYOInh7pX7hqeSu563Ig3y8gYMEiv9FWhAA'
        '6KykDAhnFkbVltkUeR1N8vmupRy-lCwUlIPlEDL8U52z7XhYA=='
    ),
    ...
    cookies={
        ...
        "__tea_cache_tokens_1988": (
            "{%22_type_%22:%22default%22%2C%22"
            "user_unique_id%22:%227300552300538447366%22%2C%22timestamp%22:1699792345959}"
        ),
        'tiktok_webapp_theme': 'light',
        "odin_tt": (
        ...
        "perf_feed_cache": (
            "{%22expireTimestamp%22:1699963200000%2C%22itemIds%22:[%227282354933548977415%22%2C"
            "%227285299893793770758%22%2C%227294698096750038278%22]}"
        ),
        ...
        "ttwid": (
            "1%7CC9pZ_LkETeWI3YqNyyt5OJKZA2nDG-eCGpUC5IxAv5c%7C1699792586%7C6d3"
            "1a60618643d829015d37c6e0b139dfd4c9358347f011432e953c6703ac43a"
        ),
    },
    params={
        'aid': '1988',
