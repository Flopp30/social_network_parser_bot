...
class MessageContainer:
    ...
    geo_parsing_welcome: str = 'Отправь ссылку для парсинга\n' 'Только tiktok (user/music).\n' 'Задача долгая, просьба учитывать это.'

    # ONE LINK STAT
    one_link_stat_welcome: str = 'Отправь ссылку на тт видео пользователя для получения статистики'
    ...
    # список
    monitoring_link_list_caption: str = 'Количество отслеживаемых ссылок: {is_active}\n' 'Всего ссылок {total}'
    monitoring_link_list_empty = 'Нет отслеживаемых ссылок.'
    # добавление
